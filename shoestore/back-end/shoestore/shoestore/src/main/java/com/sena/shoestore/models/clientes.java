...
public class clientes {
	...
	public clientes(String id_cliente, String tipo_identificacion, String identificacion,
			String nombre_cliente, String apellido_cliente, String telefono, String direccion, String ciudad,
			String estado) {
		super();
